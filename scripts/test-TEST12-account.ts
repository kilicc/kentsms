/**
 * TEST12 hesabı - CepSMS API V1.1.3 dokümantasyonuna göre test
 * 
 * Kullanım:
 *   npx tsx scripts/test-TEST12-account.ts
 */
...
async function testTEST12Account() {
  console.log('=== TEST12 Hesabı - CepSMS API V1.1.3 Format Testi ===\n');
