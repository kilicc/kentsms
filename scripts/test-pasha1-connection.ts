/**
 * pasha1 hesabı bağlantı testi
 * 
 * Kullanım:
 *   npx tsx scripts/test-pasha1-connection.ts
 */
...
async function testPasha1Connection() {
  console.log('=== pasha1 Hesabı Bağlantı Testi ===\n');
  ...
  const testMessage = 'Bağlantı testi - pasha1 hesabı';
...
// Script'i çalıştır
testPasha1Connection().catch(error => {
