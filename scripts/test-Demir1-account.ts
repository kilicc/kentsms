/**
 * Demir1 hesabı - CepSMS API V1.1.3 dokümantasyonuna göre test
 * 
 * Kullanım:
 *   npx tsx scripts/test-Demir1-account.ts
 */
...
async function testDemir1Account() {
  console.log('=== Demir1 Hesabı - CepSMS API V1.1.3 Format Testi ===\n');

  const username = 'Demir1';
  const password = 'Demir';
