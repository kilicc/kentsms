/**
 * bahi1 hesabı - CepSMS API V1.1.3 dokümantasyonuna göre test
 * 
 * Kullanım:
 *   npx tsx scripts/test-bahi1-api-doc.ts
 */
...
async function testBahi1WithAPIDoc() {
  console.log('=== bahi1 Hesabı - CepSMS API V1.1.3 Format Testi ===\n');
...
// Script'i çalıştır
testBahi1WithAPIDoc().catch(error => {
