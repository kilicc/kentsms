/**
 * Test112233 hesabı - CepSMS API V1.1.3 dokümantasyonuna göre test
 * 
 * Kullanım:
 *   npx tsx scripts/test-Test112233-account.ts
 */
...
async function testTest112233Account() {
  console.log('=== Test112233 Hesabı - CepSMS API V1.1.3 Format Testi ===\n');

  const username = 'random5';
...
// Script'i çalıştır
testTest112233Account().catch(error => {
