/**
 * random5 hesabı - CepSMS API V1.1.3 dokümantasyonuna göre test
 * 
 * Kullanım:
 *   npx tsx scripts/test-random5-account.ts
 */
...
async function testRandom5Account() {
  console.log('=== Sazlık Hesabı - CepSMS API V1.1.3 Format Testi ===\n');
  ...
  const testPhone = process.env.TEST_PHONE || '905075708797';
...
// Script'i çalıştır
testRandom5Account().catch(error => {
