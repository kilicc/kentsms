/**
 * 2043 hesabı - CepSMS API V1.1.3 dokümantasyonuna göre test
 * 
 * Kullanım:
 *   npx tsx scripts/test-2043-account.ts
 */
...
async function test2043Account() {
  console.log('=== 2043 Hesabı - CepSMS API V1.1.3 Format Testi ===\n');

  const username = '2043';
  const password = 'fgrt5rhjy';
