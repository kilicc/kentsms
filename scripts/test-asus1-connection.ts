/**
 * asus1 hesabı bağlantı testi
 * 
 * Kullanım:
 *   npx tsx scripts/test-asus1-connection.ts
 */
...
async function testAsus1Connection() {
  console.log('=== asus1 Hesabı Bağlantı Testi ===\n');
  ...
  const testMessage = 'Bağlantı testi - asus1 hesabı';
...
// Script'i çalıştır
testAsus1Connection().catch(error => {
